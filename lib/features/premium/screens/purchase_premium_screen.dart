...
class _PurchasePremiumScreenState extends State<PurchasePremiumScreen> {
  ...
  final List<Map<String, dynamic>> _plans = [
    {
      'title': 'Uji Coba Cepat (2 Menit)',
      'subtitle': 'Khusus pengujian hitung mundur akun',
      'price': 'Gratis (Demo)',
      'period': '/2 menit',
      'rawPrice': '2 Menit Demo',
      'saveTag': 'DEMO 2 MENIT',
      'isPopular': true,
  ...
  Future<void> _processPayment() async {
    ...
    try {
      ...
      if (isDemoNoBrowser) {
        ...
        // Langsung aktifkan (tanpa sheet verifikasi) karena ini mode demo
